 ...
 * keyed by [org.tatrman.ttr.metadata.graph.EdgeType] (DEFINES / REFERENCES / MAPS_TO / USES).
 *
...
object GraphDotExporter {
    ...
    private fun dotted(q: org.tatrman.ttr.metadata.model.QualifiedName): String {
        val parts =
            listOfNotNull(
...
private fun org.tatrman.ttr.metadata.model.ModelObject.kindTag(): String =
    when (this) {
        is org.tatrman.ttr.metadata.model.DbTable -> "table"
        is org.tatrman.ttr.metadata.model.DbView -> "view"
        is org.tatrman.ttr.metadata.model.DbColumn -> "column"
        is org.tatrman.ttr.metadata.model.DbProcedure -> "procedure"
        is org.tatrman.ttr.metadata.model.DbForeignKey -> "fk"
        is org.tatrman.ttr.metadata.model.Entity -> "entity"
        is org.tatrman.ttr.metadata.model.Attribute -> "attribute"
        is org.tatrman.ttr.metadata.model.Relation -> "relation"
        is org.tatrman.ttr.metadata.model.Role -> "role"
        is org.tatrman.ttr.metadata.model.Er2DbEntityMapping -> "er2db_entity"
        is org.tatrman.ttr.metadata.model.Er2DbAttributeMapping -> "er2db_attribute"
        is org.tatrman.ttr.metadata.model.Er2DbRelationMapping -> "er2db_relation"
