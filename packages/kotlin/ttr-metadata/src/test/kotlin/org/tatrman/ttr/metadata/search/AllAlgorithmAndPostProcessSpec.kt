...
class AllAlgorithmAndPostProcessSpec :
    StringSpec({
        ...
        "post-process applies threshold then page" {
            ...
            val req =
                SearchQuery(resultThreshold = 0.6f, limit = 3)
...
private fun req(query: String): SearchQuery = SearchQuery(query = query, language = "cs")
