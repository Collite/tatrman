...
import org.tatrman.ttr.metadata.model.DbProcedureParameter
import org.tatrman.ttr.metadata.model.DbSchema
import org.tatrman.ttr.metadata.model.DbTable
import org.tatrman.ttr.metadata.model.ParameterDirection
...
class MetadataExportPipelineSpec :
    StringSpec({
        ...
        fun qn(
            ...
            QualifiedName(schemaCode = parseSchemaCode(schema) ?: SchemaCode.UNSPECIFIED, namespace = ns, name = name)
        ...
        fun minimalModel(): Model {
            ...
            val attrMapping =
                Er2DbAttributeMapping(
                    ...
                    attribute = attrQn,
                    target =
                        org.tatrman.ttr.metadata.model.AttributeMappingTarget
                            .Column(colQn),
                )
            val stockRole =
                Role(
