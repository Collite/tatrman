...
sales_1 = pl.read_csv("files/sales_2026.csv", schema={"customer": pl.String, "region": pl.String, "amount": pl.Decimal})
...
b_1_t.write_ipc("out/main_result.arrow")
print(f"display main_result: out/main_result.arrow")
b_1_f.write_ipc("staging/low.arrow")
