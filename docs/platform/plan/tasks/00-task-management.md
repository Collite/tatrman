...
- [ ] `docs/platform/plan/contracts.md` ⚑ flags reviewed by Bora (PL-P0.S2 ratifies).
...
House cadence: `/review` after each phase; `[x]` marks are intent, not truth — the reviewer verifies against runtime (review artifacts: `docs/platform/implementation/review-NNN.md`, serial numbering shared with the repo's other efforts).
