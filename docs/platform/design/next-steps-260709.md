...
**Sources, read order:** `00-control-room.md` (dashboard + decision log + §9) → `01-design-space-map.md` (incl. §K, §J resolutions) → `02`–`09` option docs (each has a Convergence status section summarizing its resolutions) → `review-260708.md` (context for the amendments). TTR-P corpus (`../../ttr-p/design/`) only as needed for citations.
