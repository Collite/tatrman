...
- [ ] **T6 — Close the phase.** All six stage rows checked in `00-task-management.md`; phase-DONE checkboxes walked; findings sections compiled into a short `docs/server/tasks/sv-p0-review-input.md` for Bora's phase review; control room gets the session-index row at the review.
