...
- [ ] **T8 — Publish interim artifacts.** `./gradlew publishToMavenLocal` (all modules, `0.0.1-LOCAL`) — S5's kantheon rebuild consumes these. Record artifact list in findings. Check the S4 row.
