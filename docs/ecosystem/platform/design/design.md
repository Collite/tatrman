...
> **The technical result of the Tatrman Platform design effort (2026-07-08 → 2026-07-09).** Compact by design: this document states what was decided and what planning must produce; the *why* and the rejected alternatives live in the decision log ([`00-control-room.md`](./00-control-room.md) §7 — ground truth) and the option docs (`02`–`09`). The exhaustive narrative is [`detailed-design.md`](./detailed-design.md).
>
...
> **2026-07-10:** superseded as the near-term bar (STRAT-5); remains the Tatrman Platform (operate-tier) bar. Near-term bar = the Tatrman Server v1 statement (RO-3, `docs/ecosystem/server/`).
...
> **2026-07-10:** re-sequenced by STRAT-6 — ①② stand; ③'s hall content done in kantheon (open spine; the program door parks); ④⑦ park with the operate tier; ⑤ splits (ttr-validate = open, done; Perun parked); ⑥ remains, inside the new critical path (`docs/ecosystem/server/implementation/plan.md`).
