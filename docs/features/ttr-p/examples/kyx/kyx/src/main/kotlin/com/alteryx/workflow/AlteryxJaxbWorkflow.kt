...
enum class NodeTypes { SELECT, SUMMARIZE, SORT, FORMULA, INPUT, OUTPUT, CONTAINER, JOIN, FILTER, BROWSE, UNION ;
...
//Container
    ...
    companion object {
        ...
        fun getDefaults(whichList: NodeTypes) : AlteryxXmlNodeConfiguration {
        ...
        fun getDefaultsWithUnknown(whichList: NodeTypes) : AlteryxXmlNodeConfiguration {
...
class AlteryxXmlWorkflowFactory() {
