 ...
 */
public class ByxExternalAnnotator extends ExternalAnnotator<PsiFile, List<ByxExternalAnnotator.Issue>> {
	...
	public List<Issue> doAnnotate(final PsiFile file) {
		Collection<? extends PsiElement> funcNameNodes =
			XPath.findAll(ByxLanguage.INSTANCE, file, "/script/function/ID");
		Collection<? extends PsiElement> funcCallNameNodes =
			XPath.findAll(ByxLanguage.INSTANCE, file, "//call_expr/ID");
