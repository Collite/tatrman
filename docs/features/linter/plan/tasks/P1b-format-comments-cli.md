...
- [x] **1. (test) Comment-preservation cases.**
...
- [x] **2. (test) Idempotency + semantics-preservation with comments.**
...
- [x] **3. Emit trivia in the printer.**
