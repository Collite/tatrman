...
- [x] **1. (test) Precedence + preset resolution.**
...
- [x] **2. (test) Clamp, back-compat, unknown-rule.**
...
- [x] **4. Feed config into the runner + presets file.**
...
- [x] **5. Surface config-level diagnostics on `.ttrlint.toml`.**
...
- [x] **6. (integration) Live config watch.**
