...
- [ ] **T8 — Wrap.** Full verify block green; tick the S0 row in `00-task-management.md`; commit `RG-P3.S0: Veles semantics projection + grounding metadata seam (G2 closed)`; resume RG-P3·S1 at its T1 with the seam in place.
