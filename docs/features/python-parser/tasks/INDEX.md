...
| Stage | Mini-task-list | Status |
|---|---|---|
| 4.1 | [Tests first: semantics pytest suites](06-tests-first-semantics.md) | 🟡 4/7 suites green (qname/pkg-inference/symbol-table/pkg-graph via 4.2); resolver/stock/validator/project await 4.3–4.4 |
