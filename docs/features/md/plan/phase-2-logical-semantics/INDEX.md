...
- [x] **Stage 2D** — [Map + calc-catalog validation](2D-map-calc.md)
- [x] **Stage 2E** — [Leaf/grain lattice + hierarchy inference](2E-leaf-grain-hierarchy.md)
- [x] **Stage 2F** — [Cubelet validator + LSP wiring + integration](2F-cubelet-lsp.md)
