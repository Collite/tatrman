...
- [ ] **C2 — VS Code extension contributions.** In `packages/vscode-ext/package.json`:
...
- [ ] **C5 — Mass-rename fixtures + sample files.**
...
- [ ] **C6 — Docs.** Update `CLAUDE.md`, `docs/**`, and READMEs: every `.ttr` model-file reference
...
- [ ] **C8 — Commit.** `Section Phase0-C: rename .ttr model extension → .ttrm`.
