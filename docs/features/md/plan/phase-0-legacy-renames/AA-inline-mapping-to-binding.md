...
- [x] **AA3 — Regenerate + parser AST/walker.**
...
- [x] **AA5 — Host: format + highlight + completion.**
...
- [x] **AA6 — Migrate modeler fixtures + docs.**
...
- [x] **AA8 — Commit.** `Section Phase0-AA: rename inline mapping: → binding:`. Coordinate the merge
