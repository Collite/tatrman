...
- [x] **4.1 — Add shared fixtures.** Add a schema-less fixture file per
...
- [x] **4.2 — Extend the dump to include the schema component.** Ensure the
...
- [x] **4.3 — Run TS dump + Kotlin spec; assert identical.** Regenerate the TS
...
- [x] **4.4 — Full green + CHANGELOG.** Run the full gates:
...
- [x] **4.5 — Final feature DoD sweep.** Re-open [`INDEX.md`](INDEX.md) and tick
...
### Stage 4 DoD
- [x] Conformance harness compares resolved-qname + diagnostic-code sets for the
      schema-less fixtures and is green in CI.
- [x] All four stages' boxes ticked; `INDEX.md` DoD fully satisfied.
