...
- [x] [tasks-p3-s3.4-conformance.md](./tasks-p3-s3.4-conformance.md) — `ttrp-conform` (S3/Q9 seven points), placement variants, CI + dockerized PG (6 tasks) — **harness DONE 2026-07-07**; live PG↔Polars A4 proof GATED on SQL Join emit (see progress-phase-03.md)
