...
- [ ] **C.2.1 — Throwaway modeler bump.** In a scratch modeler branch, make a
...
- [ ] **C.2.2 — Switch ai-platform's version ref only.** On a scratch
...
- [ ] **C.2.3 — Assert zero source edits.** The suite passes with only the
...
- [ ] **C.2.4 — Update the grammar-master task index (modeler).** In
