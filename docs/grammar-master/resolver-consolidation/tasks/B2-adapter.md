...
- [x] **B.2.1 — Create the class skeleton** per contracts §2: the `private`
...
- [x] **B.2.4 — Implement the context map** (contracts §2): build `TtrCtx` from
...
- [x] **B.2.5 — Implement the result map** (contracts §2): `TtrResult.Resolved`
...
- [x] **B.2.7 — Run parity; expect the resolved/diagnostic *kind* to match.**
      ```bash
