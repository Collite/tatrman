...
## Corpus Check
- Large corpus: 711 files · ~1,531,056 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 25443 nodes · 36960 edges · 1664 communities (128 shown, 1536 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 167 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Community Hubs (Navigation)
- [[_COMMUNITY_T-SQL Keyword Contexts|T-SQL Keyword Contexts]]
- [[_COMMUNITY_PostgreSQL Bare-Label Keywords|PostgreSQL Bare-Label Keywords]]
- [[_COMMUNITY_PostgreSQL Aggregate  Alter Stmts|PostgreSQL Aggregate / Alter Stmts]]
- [[_COMMUNITY_T-SQL DDL Sub-Clauses|T-SQL DDL Sub-Clauses]]
- [[_COMMUNITY_PostgreSQL Unreserved Keywords|PostgreSQL Unreserved Keywords]]
- [[_COMMUNITY_ANTLR Generated Listener|ANTLR Generated Listener]]
- [[_COMMUNITY_T-SQL Aggregate  Windowed Funcs|T-SQL Aggregate / Windowed Funcs]]
- [[_COMMUNITY_Generated Parser Properties|Generated Parser Properties]]
- [[_COMMUNITY_T-SQL DDL Clauses|T-SQL DDL Clauses]]
- [[_COMMUNITY_PostgreSQL Visitor Targets|PostgreSQL Visitor Targets]]
- [[_COMMUNITY_PostgreSQL Parser Listener|PostgreSQL Parser Listener]]
- [[_COMMUNITY_PostgreSQL Statement Contexts|PostgreSQL Statement Contexts]]
- [[_COMMUNITY_T-SQL Parser Listener|T-SQL Parser Listener]]
- [[_COMMUNITY_PostgreSQL Parser Entry|PostgreSQL Parser Entry]]
- [[_COMMUNITY_T-SQL Parser Visitor|T-SQL Parser Visitor]]
- [[_COMMUNITY_T-SQL Parser Entry|T-SQL Parser Entry]]
- [[_COMMUNITY_T-SQL Grant Permissions|T-SQL Grant Permissions]]
- [[_COMMUNITY_PostgreSQL Policy  Column Constraints|PostgreSQL Policy / Column Constraints]]
- [[_COMMUNITY_T-SQL Analytics  Aliases|T-SQL Analytics / Aliases]]
- [[_COMMUNITY_Generated Attribute Inline|Generated Attribute Inline]]
- [[_COMMUNITY_PostgreSQL Reserved Keywords|PostgreSQL Reserved Keywords]]
- [[_COMMUNITY_T-SQL Windowed  Change Tracking|T-SQL Windowed / Change Tracking]]
- [[_COMMUNITY_Semantics Conformance Dump|Semantics Conformance Dump]]
- [[_COMMUNITY_PostgreSQL Function Expressions|PostgreSQL Function Expressions]]
- [[_COMMUNITY_PostgreSQL Constant Expressions|PostgreSQL Constant Expressions]]
- [[_COMMUNITY_Parser Package Source|Parser Package Source]]
- [[_COMMUNITY_PostgreSQL Alter Table Cmds|PostgreSQL Alter Table Cmds]]
- [[_COMMUNITY_T-SQL Batch Statements|T-SQL Batch Statements]]
- [[_COMMUNITY_T-SQL Availability Group Options|T-SQL Availability Group Options]]
...
1. `KeywordContext` - 971 edges
2. `PostgreSQLParser` - 725 edges
3. `TSqlParser` - 626 edges
4. `Bare_label_keywordContext` - 460 edges
5. `Unreserved_keywordContext` - 335 edges
6. `Ddl_clauseContext` - 173 edges
7. `TTRParser` - 160 edges
8. `StmtContext` - 132 edges
9. `Grant_permissionContext` - 112 edges
10. `Func_expr_common_subexprContext` - 95 edges

## Surprising Connections (you probably didn't know these)
- `analyzeSqlBlock()` --calls--> `parseSql()`  [INFERRED]
  tests/integration/src/embedded-sql-diagnostics.test.ts → packages/sql/src/parser-service.ts
- `loadManifest()` --calls--> `resolveManifest()`  [INFERRED]
  tests/integration/src/embedded-sql-diagnostics.test.ts → packages/semantics/src/manifest.ts
- `analyzeSqlBlock()` --calls--> `parseSql()`  [INFERRED]
  tests/integration/src/embedded-sql-ide.test.ts → packages/sql/src/parser-service.ts
- `loadManifest()` --calls--> `resolveManifest()`  [INFERRED]
  tests/integration/src/embedded-sql-ide.test.ts → packages/semantics/src/manifest.ts
- `analyzeSqlBlock()` --calls--> `parseSql()`  [INFERRED]
  tests/integration/src/embedded-sql-completion.test.ts → packages/sql/src/parser-service.ts

## Communities (1664 total, 1536 thin omitted)

### Community 5 - "ANTLR Generated Listener"
Cohesion: 0.01
Nodes (32): TTRListener, ArgsPropertyContext, AttributeProperty_Context, ColumnNamesListPropertyContext, ConstraintTypeValueContext, DefinitionContext, DefinitionSqlPropertyContext, DirectionPropertyContext (+24 more)

### Community 6 - "T-SQL Aggregate / Windowed Funcs"
Cohesion: 0.01
Nodes (31): AGGREGATE_WINDOWED_FUNCContext, ANALYTIC_WINDOWED_FUNCContext, ASCIIContext, ATN2Context, BUILT_IN_FUNCContext, CERTPRIVATEKEYContext, CURSOR_ROWSContext, ERROR_MESSAGEContext (+23 more)

### Community 9 - "PostgreSQL Visitor Targets"
Cohesion: 0.01
Nodes (20): Alterfunc_opt_listContext, AlteroptrolelistContext, Attr_nameContext, ColquallistContext, Comment_textContext, Dostmt_opt_itemContext, Explain_option_argContext, Name_listContext (+12 more)

### Community 10 - "PostgreSQL Parser Listener"
Cohesion: 0.02
Nodes (19): Aggr_argContext, Any_name_list_Context, Binary_Context, Collate_clause_Context, Createdb_opt_itemsContext, Explain_option_nameContext, From_in_Context, JsonTypeContext (+11 more)

### Community 12 - "T-SQL Parser Listener"
Cohesion: 0.02
Nodes (17): Alter_assembly_file_nameContext, Colon_colonContext, Cross_joinContext, CURRENT_TIMESTAMPContext, Drop_fulltext_catalogContext, Func_proc_name_server_database_schemaContext, Group_by_itemContext, Id_or_stringContext (+9 more)

### Community 13 - "PostgreSQL Parser Entry"
Cohesion: 0.02
Nodes (19): Aggr_args_listContext, All_clause_Context, Any_identifierContext, ConstbitContext, Createfunc_opt_listContext, Enum_val_list_Context, Fdw_options_Context, For_locking_clause_Context (+11 more)

### Community 14 - "T-SQL Parser Visitor"
Cohesion: 0.02
Nodes (17): Alter_assembly_asContext, Alter_authorization_startContext, CURRENT_USERContext, Drop_contractContext, Drop_credentialContext, Empty_statementContext, Entity_name_for_parallel_dwContext, Execute_statement_arg_unnamedContext (+9 more)

### Community 15 - "T-SQL Parser Entry"
Cohesion: 0.02
Nodes (17): Alter_assembly_dropContext, Alter_assembly_file_bitsContext, Break_statementContext, Built_in_functionsContext, Database_mirroring_optionContext, Ddl_trigger_operationContext, Drop_application_roleContext, File_directory_path_separatorContext (+9 more)

### Community 17 - "PostgreSQL Policy / Column Constraints"
Cohesion: 0.02
Nodes (3): ConstraintelemContext, CreateforeigntablestmtContext, ViewstmtContext

### Community 20 - "Generated Attribute Inline"
Cohesion: 0.03
Nodes (5): AttributeInlineContext, ColumnInlineContext, ConstraintInlineContext, IndexInlineContext, ObjectDefinitionContext

### Community 22 - "T-SQL Windowed / Change Tracking"
Cohesion: 0.03
Nodes (3): Declare_statementContext, Nodes_methodContext, Xml_data_type_methodsContext

### Community 23 - "Semantics Conformance Dump"
Cohesion: 0.05
Nodes (32): DocInput, SemanticsConformanceDump, kindOf(), collectAllReferences(), CollectedRef, collectInto(), enclosingQnameOf(), nestedDefs() (+24 more)

### Community 26 - "Parser Package Source"
Cohesion: 0.1
Nodes (60): recoveryEvent(), RecoveryReportingStrategy, resolveTag(), dedent(), dedentWithIndent(), longestCommonPrefix(), makeSourceLocation(), parseFile() (+52 more)

### Community 28 - "T-SQL Batch Statements"
Cohesion: 0.03
Nodes (3): BatchContext, Create_or_alter_functionContext, Func_body_returns_scalarContext

### Community 31 - "Community 31"
Cohesion: 0.04
Nodes (4): Column_def_table_constraintContext, Declare_set_cursor_commonContext, Dml_clauseContext, Foreign_key_optionsContext

### Community 38 - "Community 38"
Cohesion: 0.08
Nodes (10): loadProject(), collectFromEntity(), collectFromRelation(), synthesizeMappings(), synthQname(), ProjectSymbolTable, attempt(), Resolver (+2 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (3): DeclarecursorstmtContext, ExecutestmtContext, PreparablestmtContext

### Community 49 - "Community 49"
Cohesion: 0.09
Nodes (21): positionAt(), configLoc(), diag(), joinPath(), loadLintConfig(), parseLintConfig(), recommendedConfig(), resolveLintConfig() (+13 more)

### Community 50 - "Community 50"
Cohesion: 0.04
Nodes (44): AttributeDef, BoolValue, ColumnDef, ConstraintDef, DataType, Definition, DrillMapDef, EntityDef (+36 more)

### Community 52 - "Community 52"
Cohesion: 0.09
Nodes (20): applyFixesToFixpoint(), collectFiles(), lintAll(), loadProject(), collectFixtureCodes(), lineLoc(), lintDocument(), lintProject() (+12 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (3): AttributePropertyContext, EntityPropertyContext, SearchSubPropertyContext

### Community 54 - "Community 54"
Cohesion: 0.08
Nodes (30): format(), concat(), group(), indent(), join(), text(), verbatim(), blockWithComments() (+22 more)

### Community 55 - "Community 55"
Cohesion: 0.12
Nodes (43): ImportStatement, LocalizedStringListValue, LocalizedStringValue, SearchHintsValue, buildAttribute(), buildColumn(), buildConstraint(), buildIndex() (+35 more)

### Community 64 - "Community 64"
Cohesion: 0.07
Nodes (6): fileToSqlOffset(), sqlPosToFile(), collectTrivia(), identityPrint(), sourceTextOf(), tagged()

### Community 66 - "Community 66"
Cohesion: 0.1
Nodes (25): buildAddObjectEdit(), buildCreateGraphContent(), buildCreateGraphEdit(), buildRemoveObjectEdit(), buildRemoveObjectText(), buildSetLayoutEdit(), buildTextEdit(), findExistingLayoutBlock() (+17 more)

### Community 68 - "Community 68"
Cohesion: 0.07
Nodes (14): legacyLint(), analyzeSqlBlock(), loadManifest(), open(), sleep(), analyzeSqlBlock(), loadManifest(), analyzeSqlBlock() (+6 more)

### Community 71 - "Community 71"
Cohesion: 0.1
Nodes (10): lexerCtorFor(), lexSql(), resolveDialect(), maskPlaceholders(), parseSql(), model(), model(), firstTokenType() (+2 more)

### Community 88 - "Community 88"
Cohesion: 0.08
Nodes (7): createServerConnection(), boot(), pair(), sleep(), completeWithAutoImport(), pair(), sleep()

### Community 93 - "Community 93"
Cohesion: 0.13
Nodes (18): defaultNamespaceForSchema(), defaultSchemaForKind(), attributeMappingColumnRef(), collectFromEntity(), collectFromRelation(), collectMappingReferences(), columnRefFromColumnValue(), entityTargetTableQname() (+10 more)

### Community 103 - "Community 103"
Cohesion: 0.07
Nodes (3): Join_partContext, PivotContext, UnpivotContext

### Community 109 - "Community 109"
Cohesion: 0.23
Nodes (22): extract(), aliasOf(), columnRef(), dottedParts(), extractPostgres(), qnameParts(), tableRef(), aliasOf() (+14 more)

### Community 119 - "Community 119"
Cohesion: 0.15
Nodes (17): buildEdgeForDef(), buildModelGraph(), buildNodeForDef(), buildProjectModelGraph(), buildQname(), buildSymbolDetail(), buildSymbolDetailForDef(), emptyLayout() (+9 more)

### Community 137 - "Community 137"
Cohesion: 0.12
Nodes (13): dumpSem(), dumpSemDocs(), renderSem(), main(), collectFixtureCodes(), getAllModelerFiles(), loadStock(), findProjectRoot() (+5 more)

### Community 139 - "Community 139"
Cohesion: 0.12
Nodes (9): loadDemoFiles(), loadProjectViaFileSystemAccessAPI(), addToast(), async(), handleAddObject(), handleDirPick(), handleFileLoad(), handleRemoveNode() (+1 more)

### Community 145 - "Community 145"
Cohesion: 0.18
Nodes (19): dataType(), defTree(), descOf(), dump(), dumpTree(), embeddedDump(), loc(), locList() (+11 more)

### Community 146 - "Community 146"
Cohesion: 0.22
Nodes (18): buildSqlDbIndex(), reduceName(), resolveSqlRefAt(), resolveSqlReferences(), resolveSqlTableName(), resolveTableInfo(), scopeTableForQualifier(), sqlScopeTables() (+10 more)

### Community 163 - "Community 163"
Cohesion: 0.13
Nodes (8): attachTrivia(), collectNodes(), firstAfter(), innermostContaining(), isNode(), toTrivia(), trailingOwner(), TTRLexer

### Community 164 - "Community 164"
Cohesion: 0.16
Nodes (13): refactorExtractDefToNewFile(), getCodeLenses(), lineRange(), plural(), topLevelQname(), fetchCompletionConfig(), getCompletionConfig(), invalidateCompletionConfig() (+5 more)

### Community 188 - "Community 188"
Cohesion: 0.18
Nodes (17): formatCandidate(), buildImportText(), buildImportTextEdit(), compareImportTargets(), findInsertionIndex(), findInsertionLineForFirstImport(), isBlankLine(), nextNonBlankLine() (+9 more)

### Community 208 - "Community 208"
Cohesion: 0.19
Nodes (13): CharIsLetter(), CheckIfUtf32Letter(), CheckLaMinus(), CheckLaStar(), constructor(), HandleLessLessGreaterGreater(), HandleNumericFail(), IsSemiColon() (+5 more)

### Community 209 - "Community 209"
Cohesion: 0.16
Nodes (6): renderOverlay(), saveLayout(), glyphFor(), applyPositions(), buildLayout(), debounce()

### Community 210 - "Community 210"
Cohesion: 0.13
Nodes (6): handleSelect(), isOutOfScope(), createLspClient(), MissingObjectsDrawer(), goToStep3(), goToStep5()

### Community 320 - "Community 320"
Cohesion: 0.13
Nodes (5): Reference, idv(), InlineMappingRenderSpec, idv(), TtrRendererSpec

### Community 354 - "Community 354"
Cohesion: 0.16
Nodes (4): Inference, PackageInference, Qname, StockLoader

### Community 355 - "Community 355"
Cohesion: 0.23
Nodes (11): detectCompletionContext(), detectPropertyPosition(), detectSearchSubProperty(), getDefKindCompletions(), getPackageNameCompletions(), getPresentProperties(), getPropertyNameCompletions(), getSchemaCodeCompletions() (+3 more)

### Community 480 - "Community 480"
Cohesion: 0.3
Nodes (6): findCyclesOn(), PackageEdge, PackageGraph, PackageGraphBuilder, PackageNode, packageOfImport()

### Community 481 - "Community 481"
Cohesion: 0.32
Nodes (11): applySortOrderAndLimit(), buildCandidates(), detectEmptyReferencePosition(), detectReferenceProperty(), extractQueryPrefix(), findPropertyColonIndex(), findPropertyLine(), getReferenceCompletions() (+3 more)

### Community 482 - "Community 482"
Cohesion: 0.24
Nodes (8): addDefAndChildren(), buildQnameToDef(), getAllTtrgUris(), getGraph(), getPackageGraphFromCache(), listGraphs(), parseAllDocs(), computeGraphEdges()

### Community 485 - "Community 485"
Cohesion: 0.27
Nodes (8): buildRenameSymbolEdit(), buildTextEdit(), escapeRegExp(), findObjectsBrackets(), offsetToPosition(), positionToOffset(), applyEdit(), applyEdits()

### Community 577 - "Community 577"
Cohesion: 0.27
Nodes (5): ParseError, ParseResult, ParseWarning, TtrLoader, err()

### Community 578 - "Community 578"
Cohesion: 0.4
Nodes (10): buildDefSymbol(), buildDocumentSymbols(), buildGraphSymbols(), buildNestedDefSymbol(), buildTtrSymbols(), locateName(), nameRange(), nestedDefKinds() (+2 more)

### Community 579 - "Community 579"
Cohesion: 0.27
Nodes (5): collect(), Index, markUsed(), matchesId(), parseDirective()

### Community 587 - "Community 587"
Cohesion: 0.35
Nodes (8): buildRenamePackageEdit(), buildTextEdit(), escapeRegExp(), findObjectsBrackets(), offsetToPosition(), replaceQnameInObjectsList(), applyEdit(), applyEdits()

### Community 718 - "Community 718"
Cohesion: 0.38
Nodes (6): foldEq(), foldIdent(), checkSqlParameters(), isPositional(), span(), use()

### Community 756 - "Community 756"
Cohesion: 0.31
Nodes (6): escape(), getGraphResponseToModelGraph(), modelGraphToCyElements(), nodeHeight(), nodeLabelHtml(), renderRowHtml()

### Community 944 - "Community 944"
Cohesion: 0.25
Nodes (4): analyzeSqlBlock(), loadManifest(), open(), sleep()

### Community 998 - "Community 998"
Cohesion: 0.53
Nodes (6): buildGrammar(), escapeRegex(), getScriptDir(), main(), parseGrammar(), tokenToScope()

### Community 1000 - "Community 1000"
Cohesion: 0.31
Nodes (5): applyTextEdits(), applyWorkspaceEdit(), positionToOffset(), getText(), openDoc()

### Community 1461 - "Community 1461"
Cohesion: 0.43
Nodes (4): covers(), findSqlRefAtOffset(), sqlCompletionContext(), sqlScopeFromTokens()

### Community 1462 - "Community 1462"
Cohesion: 0.33
Nodes (4): analyzeSqlBlock(), diagsFor(), loadManifest(), sleep()

### Community 1538 - "Community 1538"
Cohesion: 0.48
Nodes (5): constructor(), OnlyAcceptableOps(), ParseRoutineBody(), trimQuotes(), unquote()

### Community 1564 - "Community 1564"
Cohesion: 0.6
Nodes (5): createPairedConnection(), loadSample(), sleep(), walkGraphs(), walkTtr()

### Community 1576 - "Community 1576"
Cohesion: 0.7
Nodes (4): list(), main(), read(), reportDiff()
...
Cohesion: 0.7
Nodes (4): loadErrorCodes(), pair(), sleep(), walk()

### Community 1581 - "Community 1581"
Cohesion: 0.7
Nodes (3): buildQname(), parseQname(), qnameToString()

### Community 1582 - "Community 1582"
Cohesion: 0.5
Nodes (4): main(), The script transforms the grammar to fit for the c++ target, Transforms the grammar to fit for the target, transform_grammar()

## Knowledge Gaps
- **85 isolated node(s):** `ParseDirectorySpec`, `TtrLoaderSpec`, `InlineMappingsSpec`, `DrillMapParserSpec`, `SearchBlockSpec` (+80 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **1536 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `sqlSpanToRange()` connect `Community 164` to `Community 64`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `sqlPosToFile()` connect `Community 64` to `Community 164`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `lexSql()` connect `Community 71` to `Community 1461`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **What connects `ParseDirectorySpec`, `TtrLoaderSpec`, `InlineMappingsSpec` to the rest of the system?**
  _85 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `T-SQL Keyword Contexts` be split into smaller, more focused modules?**
  _Cohesion score 0.0 - nodes in this community are weakly interconnected._
- **Should `PostgreSQL Bare-Label Keywords` be split into smaller, more focused modules?**
  _Cohesion score 0.0 - nodes in this community are weakly interconnected._
- **Should `PostgreSQL Aggregate / Alter Stmts` be split into smaller, more focused modules?**
